            ...
            <div class="form" style="width: 600px;">
                <form class="form" method="post" onsubmit="" action="main?command=addEventResult" charset="UTF-8">
                    ...
                    <div class="input-div">
                        ...
                        <input name="winner-score" type="text" pattern="[0-9]+" placeholder="<fmt:message bundle="${loc}" key="label.score"/>" title="<fmt:message bundle="${loc}" key="help.numbers"/>"/>
                    </div>
                    <div class="input-div">
                        ...
                        <input name="loser-score" type="text" pattern="[0-9]+" placeholder="<fmt:message bundle="${loc}" key="label.score"/>" title="<fmt:message bundle="${loc}" key="help.numbers"/>"/>
                    </div>
